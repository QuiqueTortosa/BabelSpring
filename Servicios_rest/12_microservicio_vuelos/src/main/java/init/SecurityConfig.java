...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET,"/Vuelo/*").anonymous()
		.antMatchers(HttpMethod.GET,"/Vuelo").anonymous()
		.antMatchers(HttpMethod.GET,"/Vuelos").anonymous()
		.antMatchers(HttpMethod.POST,"/Vuelo").hasRole("ADMIN")
		.antMatchers(HttpMethod.PUT,"/Vuelo").anonymous()
		.antMatchers(HttpMethod.DELETE,"/Vuelo/*").hasRole("OPERATOR")
		.and()
