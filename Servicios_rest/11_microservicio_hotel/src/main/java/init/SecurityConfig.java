...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET,"/Hotel/*").anonymous()
		.antMatchers(HttpMethod.GET,"/Hoteles").anonymous()
		.antMatchers(HttpMethod.POST,"/Hotel").hasRole("ADMIN")
		.antMatchers(HttpMethod.PUT,"/Hotel").hasRole("ADMIN")
		.antMatchers(HttpMethod.DELETE,"/Hotel/*").hasRole("OPERATOR")
		.and()
